# Capture checklist — `chamfered_bracket_success`

> Generated from `evaluations/cases/chamfered_bracket_success.json`. Do not edit by hand —
...
| Tier | `contract` |
| Disposition | `succeed` |
| Expected workflow | `create_chamfered_bracket` |
| Expected tool call | `create_chamfered_bracket` |
| Bridge | `mock` |
...
> Create a chamfered L-bracket, width 50 mm, height 70 mm, thickness 8 mm, leg thickness 8 mm, and chamfer distance 2 mm.
...
Save to `evaluations/expected/claude/chamfered_bracket_success.json` with these top-level fields:
