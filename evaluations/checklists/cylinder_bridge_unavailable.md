# Capture checklist — `cylinder_bridge_unavailable`

> Generated from `evaluations/cases/cylinder_bridge_unavailable.json`. Do not edit by hand —
...
> Make a 20 mm cylinder 50 mm tall.
...
Save to `evaluations/expected/claude/cylinder_bridge_unavailable.json` with these top-level fields:
