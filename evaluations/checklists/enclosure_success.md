# Capture checklist — `enclosure_success`

> Generated from `evaluations/cases/enclosure_success.json`. Do not edit by hand —
...
| Tier | `contract` |
| Disposition | `succeed` |
| Expected workflow | `create_simple_enclosure` |
| Expected tool call | `create_simple_enclosure` |
| Bridge | `mock` |
...
> Design an enclosure, 120 mm wide, 100 mm deep, 60 mm high, with a wall thickness of 3 mm.
...
Save to `evaluations/expected/claude/enclosure_success.json` with these top-level fields:
