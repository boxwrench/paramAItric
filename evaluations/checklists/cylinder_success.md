# Capture checklist — `cylinder_success`

> Generated from `evaluations/cases/cylinder_success.json`. Do not edit by hand —
...
> I need a cylinder, diameter is 20 mm, height is 50 mm.
...
Save to `evaluations/expected/claude/cylinder_success.json` with these top-level fields:
