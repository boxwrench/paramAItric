...
Use this directory as the canonical repo-facing documentation surface.

## Current Canon

Start here when you need the current product and planning story:
...
- completed migration writeups
- superseded session handoffs
- retired example-specific docs

Historical files may still be useful for context, but they should not be treated as current repo guidance without checking the active docs first.
